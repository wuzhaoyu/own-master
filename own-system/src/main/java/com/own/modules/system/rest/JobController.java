...
public class JobController {
    ...
    @PreAuthorize("@own.check('job:list')")
    ...
    @ApiOperation("查询岗位")
    @GetMapping
    @PreAuthorize("@own.check('job:list','user:list')")
    ...
    @ApiOperation("新增岗位")
    @PostMapping
    @PreAuthorize("@own.check('job:add')")
    ...
    @ApiOperation("修改岗位")
    @PutMapping
    @PreAuthorize("@own.check('job:edit')")
    ...
    @ApiOperation("删除岗位")
    @DeleteMapping
    @PreAuthorize("@own.check('job:del')")

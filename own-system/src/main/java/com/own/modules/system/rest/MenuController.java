...
public class MenuController {
    ...
    @PreAuthorize("@own.check('menu:list')")
    ...
    @PreAuthorize("@own.check('menu:list','roles:list')")
    ...
    @ApiOperation("新增菜单")
    @PostMapping
    @PreAuthorize("@own.check('menu:add')")
    ...
    @ApiOperation("修改菜单")
    @PutMapping
    @PreAuthorize("@own.check('menu:edit')")
    ...
    @ApiOperation("删除菜单")
    @DeleteMapping
    @PreAuthorize("@own.check('menu:del')")

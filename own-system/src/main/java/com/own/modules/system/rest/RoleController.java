...
public class RoleController {
    ...
    @GetMapping(value = "/{id}")
    @PreAuthorize("@own.check('roles:list')")
    ...
    @PreAuthorize("@own.check('role:list')")
    ...
    @PreAuthorize("@own.check('roles:list','user:add','user:edit')")
    ...
    @ApiOperation("新增角色")
    @PostMapping
    @PreAuthorize("@own.check('roles:add')")
    ...
    @ApiOperation("修改角色")
    @PutMapping
    @PreAuthorize("@own.check('roles:edit')")
    ...
    @ApiOperation("删除角色")
    @DeleteMapping
    @PreAuthorize("@own.check('roles:del')")
